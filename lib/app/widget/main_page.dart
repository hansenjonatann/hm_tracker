...
import 'package:hm_tracker/app/modules/savings/views/savings_view.dart';
import 'package:hm_tracker/app/modules/profile/views/profile_view.dart';
  ...
  Widget build(BuildContext context) {
    return PersistentTabView(
      tabs: [
        ...
        _buildTab(SavingsView(), Icons.savings, "Tabungan"),
        _buildTab(ProfileView(), Icons.person, "Profil"),
      ],
      navBarBuilder: (navBarConfig) => Style2BottomNavBar(
        navBarConfig: navBarConfig,
        height: 70,

        navBarDecoration: NavBarDecoration(color: primary),
      ),
    );
  }

  PersistentTabConfig _buildTab(Widget screen, IconData icon, String title) {
